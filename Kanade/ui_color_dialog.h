...
public:
    ...
    void setupUi(QDialog *Color_Dialog)
    {
        ...
        preview->setProperty("alpha_mode", QVariant(Color_Preview::SplitAlpha));
        ...
        slide_hue = new Gradient_Slider(Color_Dialog);
        slide_hue->setObjectName(QStringLiteral("slide_hue"));
        slide_hue->setMaximum(359);
        slide_hue->setOrientation(Qt::Horizontal);
        ...
        label_4 = new QLabel(Color_Dialog);
        ...
        line_2 = new QFrame(Color_Dialog);
        ...
        button_pick = new QPushButton(Color_Dialog);
        button_pick->setObjectName(QStringLiteral("button_pick"));
        QIcon icon1(QIcon::fromTheme(QStringLiteral("color-picker")));
        button_pick->setIcon(icon1);

        horizontalLayout_2->addWidget(button_pick);
    ...
    void retranslateUi(QDialog *Color_Dialog)
    {
        ...
        label_4->setText(QApplication::translate("Color_Dialog", "Alpha", 0));
        label->setText(QApplication::translate("Color_Dialog", "Red", 0));
        button_pick->setText(QApplication::translate("Color_Dialog", "Pick", 0));
    } // retranslateUi
